...
ALTER TABLE environments ADD COLUMN user_id TEXT;
ALTER TABLE history_entries ADD COLUMN user_id TEXT;
ALTER TABLE folders ADD COLUMN user_id TEXT;
ALTER TABLE saved_requests ADD COLUMN user_id TEXT;
ALTER TABLE variables ADD COLUMN user_id TEXT;
ALTER TABLE ws_sessions ADD COLUMN user_id TEXT;
